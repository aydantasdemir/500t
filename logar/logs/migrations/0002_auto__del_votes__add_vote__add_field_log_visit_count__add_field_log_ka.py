...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'logs', ['Vote'])

        # Adding field 'Log.visit_count'
        db.add_column('logs', 'visit_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Log.karma'
        db.add_column('logs', 'karma',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Log.visit_count'
        db.delete_column('logs', 'visit_count')

        # Deleting field 'Log.karma'
        db.delete_column('logs', 'karma')
